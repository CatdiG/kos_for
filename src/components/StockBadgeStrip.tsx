...
// postmarket(급등주 기반)은 statusBadge 자체를 계산하지 않는 소스라 이 목록에 넣어도 절대 선택되지
// 않지만(freshnessRank는 b.statusBadge가 있는 항목에만 쓰임), 명시적으로 최하위에 둬 의도를 남긴다.
const FRESHNESS_PRIORITY = ['foreign', 'organ', 'program', 'overlap-daily', 'overlap-2d', 'overlap-3d', 'postmarket'];
