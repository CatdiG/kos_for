...
export const metadata: Metadata = {
  title: 'KIS 주식 수급 분석 대시보드 | 외국인 · 기관 · 프로그램 순매수 추이',
  description:
    '한국투자증권 Open API 기반 실시간 국내주식 외국인, 기관, 프로그램 수급 현황 및 5일/20일/60일 누적 순매수 차트 비교 분석',
  keywords: 'KIS, 한국투자증권, 수급분석, 외국인순매수, 기관순매수, 프로그램매매, 주식차트, KOSPI, KOSDAQ',
};
